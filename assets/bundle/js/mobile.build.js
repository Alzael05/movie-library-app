...
(function ($) {
  ...
  $.fn.navpanel.methods = { options: function options(jq) {
...
(function ($) {
  ...
  $.mobile = { defaults: { animation: "slide", direction: "left", reverseDirections: { up: "down", down: "up", left: "right", right: "left" } }, panels: [], init: function init(_6) {
      $.mobile.panels = [];
